...
public class Guess3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnWrong4 = new javax.swing.JButton();
        ...
        btnWrong5 = new javax.swing.JButton();
        ...
        getContentPane().add(btnStart, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 550, 240, -1));

        jPanel2.setBackground(new java.awt.Color(204, 204, 0));
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        btnWrong2.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        btnWrong2.setText("Pidgeot");
        btnWrong2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnWrong2ActionPerformed(evt);
            }
        });
        jPanel2.add(btnWrong2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 430, 140, -1));

        btnWrong3.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        btnWrong3.setText("Kakuna");
        btnWrong3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnWrong3ActionPerformed(evt);
            }
        });
        jPanel2.add(btnWrong3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 480, 140, -1));

        btnWrong4.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        btnWrong4.setText("Tentacool");
        btnWrong4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnWrong4ActionPerformed(evt);
            }
        });
        jPanel2.add(btnWrong4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 430, 140, -1));
        ...
        btnWrong5.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        btnWrong5.setText("Mr. Mime");
        btnWrong5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnWrong5ActionPerformed(evt);
            }
        });
        jPanel2.add(btnWrong5, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 480, 140, -1));

        btnWrong1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        btnWrong1.setText("Mankey");
        btnWrong1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnWrong1ActionPerformed(evt);
            }
        });
        jPanel2.add(btnWrong1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 430, 140, -1));

        btnCorrect.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        btnCorrect.setText("Bellsprout");
        btnCorrect.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCorrectActionPerformed(evt);
            }
        });
        jPanel2.add(btnCorrect, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 480, 140, -1));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 0, 520, 640));

        lblTen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pokémon/quiz/PokemonBellsprout.jpg"))); // NOI18N
        getContentPane().add(lblTen, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        lblTenGif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pokémon/quiz/PokemonBellsproutgif.gif"))); // NOI18N
        getContentPane().add(lblTenGif, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    private void btnWrong2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWrong2ActionPerformed
        lblResults.show();
        lblResults.setText("Pidgeot is wrong!");
    ...
    private void btnWrong3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWrong3ActionPerformed
        lblResults.show();
        lblResults.setText("Kakuna is wrong!");
    ...
    private void btnWrong4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWrong4ActionPerformed
        lblResults.show();
        lblResults.setText("Tentacool is wrong!");
        btnWrong4.setEnabled(false);
        life--;
        Life.setText("" + life);
        if (life==0) {
            Gameover me = new Gameover();
    ...
    }//GEN-LAST:event_btnWrong4ActionPerformed

    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        Endgame start = new Endgame();
        start.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnNextActionPerformed

    private void btnWrong5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWrong5ActionPerformed
        lblResults.show();
        lblResults.setText("Mr. Mime is wrong!");
        btnWrong5.setEnabled(false);
        life--;
        Life.setText("" + life);
        if (life==0) {
            Gameover me = new Gameover();
    ...
    private void btnCorrectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCorrectActionPerformed
        ...
        lblResults.show();
        lblResults.setText("Bellsprout is correct!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Guess3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btnWrong4;
    private javax.swing.JButton btnWrong5;
